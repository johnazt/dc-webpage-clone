		...
		<div className='mb-16'>
			...
			>
				{getToKnow.map((slide, index) => (
					<div
						className='w-full bg-cover min-h-[60vh] bg-center flex flex-col justify-center items-center text-white before:bg-gradient-to-t before:from-black before:to-black-opacity-5  before:absolute before:inset-0 
                        '
						style={{
