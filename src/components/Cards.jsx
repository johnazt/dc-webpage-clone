...
export const Cards = () => {
	...
	return (
		<div className='px-3 py-12 grid sm:grid-cols-2 gap-6 max-w-[540px] md:max-w-[720px] lg:grid-cols-4 m-auto lg:max-w-[960px] xl:max-w-[1140px] xxl:max-w-[1320px]'>
			{cards.map(({ imgDesk, imgMob, title, small, textBtn }) => (
				...
				>
					...
					<div>
						...
						<p className='text-[1.45rem] font-extrabold mx-auto mb-16 px-2 tracking-tighter'>
							{title}
						</p>
					</div>
