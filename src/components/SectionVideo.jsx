...
const SectionVideo = () => (
	<section className='flex flex-col m-auto lg:max-w-[960px] lg:flex-row xl:max-w-[1140px] xxl:max-w-[1320px] mb-20 px-3  h-full max-w-[540px] md:max-w-[720px] gap-4 '>
		<iframe
		...
		<div className='lg:self-center'>
			...
			<p className='text-[1.35rem] md:text-[2rem] uppercase font-extrabold  mb-3 tracking-tighter'>
