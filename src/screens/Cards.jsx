...
export const Cards = () => {
  ...
  return (
    <div className='px-3 py-14 grid sm:grid-cols-2 gap-6 min-h-[700px] max-w-[540px] md:max-w-[720px] lg:grid-cols-4 m-auto lg:max-w-[960px] xl:max-w-[1140px] xxl:max-w-[1320px]'>
